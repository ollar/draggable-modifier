...
export default class DraggableModifier extends Modifier {
  ...
  constructor(modifier, { named }) {
    ...
    this.handlePanStart = named.handlePanStart
      ? (e) => named.handlePanStart(e, handlePanStart, this)
      : handlePanStart;

    this.handlePanMove = named.handlePanMove
      ? (e) => named.handlePanMove(e, handlePanMove, this)
      : handlePanMove;

    this.handlePanEnd = named.handlePanEnd
      ? (e) => named.handlePanEnd(e, handlePanEnd, this)
      : handlePanEnd;

    this.onPanEnvComplete = named.onPanEnvComplete
